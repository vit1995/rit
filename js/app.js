...
***************************************************************************** */
    ...
    da.init();
    const catalogBt = document.querySelector(".catalog__button-icon");
    catalogBt.addEventListener("click", (function(e) {
    ...
    function documentActions(e) {
        ...
        if (targetElement.closest("[data-parent]")) {
            const subMenuId = targetElement.dataset.parent ? targetElement.dataset.parent : console.log("нету дата атрибута");
            ...
            } else console.log("не нашел саб меню");
        }
        if (targetElement.closest(".catalog__back")) {
            document.documentElement.classList.remove("catalog-open");
            e.preventDefault();
        }
        if (targetElement.closest(".catalog__sub-back")) {
            document.documentElement.classList.remove("sub-menu-open");
